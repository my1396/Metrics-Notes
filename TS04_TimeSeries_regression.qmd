...
- The <span style="color: #008B45;">**long-run propensity**</span> (LRP), also called the <span style="color: #008B45;">long-run multiplier</span> or <span style="color: #008B45;">total multiplier</span>, is the final effect on $y$ on the sustained increase after $q$ or more periods have elapsed and is given by the equation:
