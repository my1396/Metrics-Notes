...
The **vector represetation** is given by:
...
$$
\begin{aligned}
y_{mt} &= \mu_m + a_{m1,1} y_{1, t-1} + a_{m2,1} y_{2, t-1} + \cdots + a_{mm,1} y_{m, t-1}  \\
&\phantom{=} \quad + a_{m1,2} y_{1, t-2} + a_{m2,2} y_{2, t-2} + \cdots + a_{mm,2} y_{m, t-2} \\
&\phantom{=} \quad + \cdots + a_{m1,p} y_{1, t-p} + a_{m2,p} y_{2, t-p} + \cdots + a_{mm,p} y_{m, t-p} + \varepsilon_{mt} \\
&= \mu_m + \sum_{j=1}^p [A_\ell]_{m1} y_{1, t-\ell} + \sum_{j=1}^p [A_\ell]_{m2} y_{2, t-\ell} + \cdots + \sum_{j=1}^p [A_\ell]_{mm} y_{m, t-\ell} + \varepsilon_{mt}
\end{aligned}
$$
...
$$
\begin{aligned}
\text{IRF}_{ij}(h) &= \frac{\partial}{\partial \varepsilon_{jt}} \left( \sum_{k=h}^\infty [\bPsi_k]_{ij} \varepsilon_{i, t+h-k} \right) \\
&= \frac{\partial}{\partial \varepsilon_{jt}} \left( \sum_{\ell=0}^\infty [\bPsi_{h+\ell}]_{ij} \varepsilon_{i, t-\ell} \right)
\end{aligned}
$$
