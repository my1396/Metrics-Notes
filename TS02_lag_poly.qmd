...
## Inverses {#sec-lag-polynomial-inverse}
...
L^1: &\quad  \psi_1 - \psi_0\phi_1 = 0 \Longrightarrow \psi_1 = \psi_0\phi_1 = \phi_1 \\
L^2: &\quad  \psi_2 - \psi_1\phi_1 - \psi_0\phi_2 = 0 \Longrightarrow \psi_2 = \psi_1\phi_1 + \psi_0\phi_2 = \phi_1^2 + \phi_2 \\
\vdots \\
...
<div class="env-green">
$$
\psi_p = \sum_{j=1}^p \psi_{p-j}\phi_j, \text{ for } p\geq 1.
$$
</div>

::: {#exm-inverse}
Consider a <span class="env-green">**1st degree lag polynomial** $\phi(L)=1-\phi L$</span>, its inverse $\psi(L)$ can be calculated as 
