...
Arther Melvin Okun was an economist who posited that there was a relationship between the change in unemployment from one period to the next and the rate of growth of output in the economy. 
...
A 1% increase in the growth rate of GDP leads to a fall in the unemployment rate of 0.44% in the current quarter, a fall of 0.09% in the next quarter. The delayed effects stop beyond the first lag.
