...
> Alternative notation: Sometimes you see the moment conditions as $\E[Z_i' u_{i\cdot}^*] = \boldsymbol{0}$, where $u_{i\cdot}^*$ refers to the first difference transformed erros. 
