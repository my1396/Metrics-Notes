...
One consequence of the serial correlated errors is that the standard error and $t$ statistics are not valid anymore. In this case, you can either 

- transform the model to remove the serial correlation, or alternatively,
    
    FGLS (Feasible Genralized Least Squares)
    
- you can use serial correlation-robust standard errors
