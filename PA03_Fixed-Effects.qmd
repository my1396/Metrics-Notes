...
Under @eq-within-lecture-random-intercept, <span class="env-green">the within transformation eliminates the individual random intercepts $\alpha_i$</span>. All average differences in $y$'s or $\bx$'s between individuals have been wiped out.
